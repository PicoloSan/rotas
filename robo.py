...
# lê as coordenadas do json
coords = read_json('screen.json')
...
for row in range(umalinha, max_cells + umalinha):
    ...
    if cell.value is not None:
        ...
        pyautogui.moveTo(coords['lupa']['x'], coords['lupa']['y'])
        time.sleep(0.5)
        pyautogui.click()
        time.sleep(2.5)
        pyautogui.moveTo(coords['id']['x'], coords['id']['y'])
        time.sleep(0.5)
        pyautogui.click()
        time.sleep(0.5)
        pyautogui.press('tab')
        ...
        time.sleep(0.5)
        pyautogui.moveTo(coords['registro']['x'], coords['registro']['y'])
        time.sleep(0.5)
        pyautogui.click()
        time.sleep(0.5)
        pyautogui.moveTo(coords['menu']['x'], coords['menu']['y'])
        time.sleep(0.5)
        pyautogui.click()
        time.sleep(0.5)
        pyautogui.moveTo(coords['submenu']['x'], coords['submenu']['y'])
        time.sleep(0.5)
        pyautogui.click()
        time.sleep(0.5)
        pyautogui.moveTo(coords['fechar']['x'], coords['fechar']['y'])
        time.sleep(0.5)
        pyautogui.click()
    else:
        ret = messagebox.showinfo("Rotas", "Planilha processada com sucesso!")
        encerrou_antes = True
        break

if encerrou_antes == False:
